...
public class Notepad extends JFrame implements ActionListener, DocumentListener {
    ...
    public Notepad() {
        ...
        fileMenu_New = new JMenuItem("New File(N)");
        ...
        editMenu_FindNext = new JMenuItem("Next(N)");
        ...
        editMenu_SelectAll = new JMenuItem("All(A)", 'A');
        ...
        editMenu_TimeDate = new JMenuItem("Date/Time(D)", 'D');
        ...
        formatMenu_LineWrap = new JCheckBoxMenuItem("Wrap(W)");
        ...
        popupMenu_SelectAll = new JMenuItem("All(A)");
    ...
    public void exitWindowChoose() {
        ...
        if (currentValue.equals(oldValue) == true) {
            ...
            int exitChoose = JOptionPane.showConfirmDialog(this, "Your file is not saved yet, save or not ?", "Exitʾ", JOptionPane.YES_NO_CANCEL_OPTION);
            if (exitChoose == JOptionPane.YES_OPTION) {    //boolean isSave=false;
                if (isNewFile) {
                    ...
                    if (result == JFileChooser.CANCEL_OPTION) {
                        statusLabel.setText("Your file is not saved");
                        return;
                    }
    ...
    public void find() {
        ...
        JLabel findContentLabel = new JLabel("Search Content(N)");
        ...
        findNextButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (upButton.isSelected()) {    //k=strA.lastIndexOf(strB,editArea.getCaretPosition()-1);
                    if (editArea.getSelectedText() == null) k = strA.lastIndexOf(strB, editArea.getCaretPosition() - 1);
                    else k = strA.lastIndexOf(strB, editArea.getCaretPosition() - findText.getText().length() - 1);
                    if (k > -1) {    //String strData=strA.subString(k,strB.getText().length()+1);
                        editArea.setCaretPosition(k);
                        editArea.select(k, k + strB.length());
                    } else {
                        JOptionPane.showMessageDialog(null, "cannot find your desired content", "search", JOptionPane.INFORMATION_MESSAGE);
                    }
                } else if (downButton.isSelected()) {
                    if (editArea.getSelectedText() == null) k = strA.indexOf(strB, editArea.getCaretPosition() + 1);
                    else k = strA.indexOf(strB, editArea.getCaretPosition() - findText.getText().length() + 1);
                    if (k > -1) {    //String strData=strA.subString(k,strB.getText().length()+1);
                        editArea.setCaretPosition(k);
                        editArea.select(k, k + strB.length());
                    } else {
    ...
    public void replace() {
        ...
        JButton replaceButton = new JButton("Replce(R)");
        ...
        final JCheckBox matchCheckBox = new JCheckBox("Case Sensetive(C)");
        ButtonGroup bGroup = new ButtonGroup();
        final JRadioButton upButton = new JRadioButton("Up(U)");
        final JRadioButton downButton = new JRadioButton("Down(D)");
        downButton.setSelected(true);
        ...
        replaceAllButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (findText.getText().length() == 0) {
                    JOptionPane.showMessageDialog(replaceDialog, "Please fill in the search content!", "Hint", JOptionPane.WARNING_MESSAGE);
                ...
                while (k > -1) {
                    ...
                    if (upButton.isSelected()) {    //k=strA.lastIndexOf(strB,editArea.getCaretPosition()-1);
                        ...
                        if (k > -1) {    //String strData=strA.subString(k,strB.getText().length()+1);
                            ...
                            if (replaceCount == 0) {
                                JOptionPane.showMessageDialog(replaceDialog, "cannot find your desired content!", "NotePad", JOptionPane.INFORMATION_MESSAGE);
                            } else {
                                JOptionPane.showMessageDialog(replaceDialog, "Successfully replace " + replaceCount + "content items!", "Successfully replaced", JOptionPane.INFORMATION_MESSAGE);
                            }
                        }
                    } else if (downButton.isSelected()) {
                        if (editArea.getSelectedText() == null) k = strA.indexOf(strB, editArea.getCaretPosition() + 1);
    ...
    public void font() {
        ...
        JLabel styleLabel = new JLabel("Character Pattern(Y)");
        ...
        //styleText.selectAll();
        if (currentFont.getStyle() == Font.PLAIN) styleText.setText("Plain");
        else if (currentFont.getStyle() == Font.BOLD) styleText.setText("Bold");
        else if (currentFont.getStyle() == Font.ITALIC) styleText.setText("Italic");
        else if (currentFont.getStyle() == (Font.BOLD + Font.ITALIC)) styleText.setText("Bold-italic");
        styleText.selectAll();
        ...
        final String fontStyle[] = {"plain", "bold", "italic", "bold-italic"};
        styleList = new JList(fontStyle);
        styleList.setFixedCellWidth(86);
        styleList.setFixedCellHeight(20);
        styleList.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        if (currentFont.getStyle() == Font.PLAIN) styleList.setSelectedIndex(0);
        else if (currentFont.getStyle() == Font.BOLD) styleList.setSelectedIndex(1);
        else if (currentFont.getStyle() == Font.ITALIC) styleList.setSelectedIndex(2);
        else if (currentFont.getStyle() == (Font.BOLD + Font.ITALIC)) styleList.setSelectedIndex(3);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == fileMenu_New) {
            ...
            if (isTextChange) {
                int saveChoose = JOptionPane.showConfirmDialog(this, "Your file is not saved, save it or not?", "Hint", JOptionPane.YES_NO_CANCEL_OPTION);
                if (saveChoose == JOptionPane.YES_OPTION) {
                    ...
                    int result = fileChooser.showSaveDialog(this);
                    if (result == JFileChooser.CANCEL_OPTION) {
                        statusLabel.setText("You haven't chosen any file yet");
                        return;
                    }
                    File saveFileName = fileChooser.getSelectedFile();
                    if (saveFileName == null || saveFileName.getName().equals("")) {
                        ...
                        try {
                            ...
                            oldValue = editArea.getText();
                            this.setTitle(saveFileName.getName() + " - Notepad");
                            statusLabel.setText("The current file: " + saveFileName.getAbsoluteFile());
                        } catch (IOException ioException) {
                        }
                    }
            ...
            boolean isTextChange = (currentValue.equals(oldValue)) ? false : true;
            if (isTextChange) {
                int saveChoose = JOptionPane.showConfirmDialog(this, "Your file is not saved yer, save it or not?", "Hint", JOptionPane.YES_NO_CANCEL_OPTION);
                if (saveChoose == JOptionPane.YES_OPTION) {
                    String str = null;
                    JFileChooser fileChooser = new JFileChooser();
                    fileChooser.setFileSelectionMode(JFileChooser.FILES_ONLY);
                    ...
                    int result = fileChooser.showSaveDialog(this);
                    if (result == JFileChooser.CANCEL_OPTION) {
                        statusLabel.setText("You haven't chosen any file");
                        return;
                    }
                    File saveFileName = fileChooser.getSelectedFile();
                    if (saveFileName == null || saveFileName.getName().equals("")) {
                    ...
                    if (fileName == null || fileName.getName().equals("")) {
                        ...
                        try {
                            ...
                            statusLabel.setText(" The current file: " + fileName.getAbsoluteFile());
                            fr.close();
                            isNewFile = false;
            ...
            if (saveFileName == null || saveFileName.getName().equals("")) {
                ...
                try {
                    ...
                    fw.close();
                    oldValue = editArea.getText();
                    this.setTitle(saveFileName.getName() + "  - NotePads");
                    statusLabel.setText("The current file: " + saveFileName.getAbsoluteFile());
                } catch (IOException ioException) {
                }
            }
            ...
            editArea.requestFocus();
            JOptionPane.showMessageDialog(this, "Sorry, this function hasn't been fullfilled yet", "Hintʾ", JOptionPane.WARNING_MESSAGE);
        } else if (e.getSource() == fileMenu_Print) {
            editArea.requestFocus();
            JOptionPane.showMessageDialog(this, "Sorry, this function hasn't been fullfilled yet", "Hint", JOptionPane.WARNING_MESSAGE);
        } else if (e.getSource() == fileMenu_Exit) {
            int exitChoose = JOptionPane.showConfirmDialog(this, "Do you want to exit?", "Exit hint", JOptionPane.OK_CANCEL_OPTION);
        ...
        //}
            ...
            if (formatMenu_LineWrap.getState()) editArea.setLineWrap(true);
            else editArea.setLineWrap(false);

        } else if (e.getSource() == formatMenu_Font) {
            editArea.requestFocus();
            font();
        } else if (e.getSource() == viewMenu_Status) {
            if (viewMenu_Status.getState()) statusLabel.setVisible(true);
            else statusLabel.setVisible(false);
        } else if (e.getSource() == helpMenu_HelpTopics) {
            editArea.requestFocus();
            JOptionPane.showMessageDialog(this, "Ready for Help", "Help Topics", JOptionPane.INFORMATION_MESSAGE);
        } else if (e.getSource() == helpMenu_AboutNotepad) {
            editArea.requestFocus();
            JOptionPane.showMessageDialog(this, "&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&\n" + " Developer: Cheng Kun Che \n" + " Release Time: Sept 2017 \n", "NotePad", JOptionPane.INFORMATION_MESSAGE);
        }
    }
