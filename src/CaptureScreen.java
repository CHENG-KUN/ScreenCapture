...
public class CaptureScreen extends JFrame implements ActionListener {
    ...
    private void initWindow(){
        start=new JButton("START SCREENSHOT");
        cancel=new JButton("EXIT");
        start.addActionListener(this);
        cancel.addActionListener(this);
        JPanel buttonJP=new JPanel();
        c=new JPanel(new BorderLayout());
        JLabel jl=new JLabel("SCREEN CAPTURE", JLabel.CENTER);
        JLabel jl1=new JLabel("DEVELOPED BY: CHENGKUN CHE",JLabel.CENTER);
        jl.setFont(new Font("TimesRoman",Font.BOLD,40));
        ...
        buttonJP.add(start);
        buttonJP.add(cancel);
        buttonJP.setBorder(BorderFactory.createTitledBorder("OPERATIONAL AREA"));
        JPanel jp=new JPanel();
        jp.add(java=new JRadioButton("Java Interface"));
        jp.add(system=new JRadioButton("System Interface",true));
        ...
        try{
            if(get==null){
                JOptionPane.showMessageDialog(this
                  , "Image cannot be empty!!", "Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
    ...
    public void doCopy(final BufferedImage image){
        try{
            ...
            JOptionPane.showMessageDialog(this,"Already copied to Clipboard!");
        }catch(Exception exe){
            exe.printStackTrace();
            JOptionPane.showMessageDialog(this
              ,"Wrong when copied to clipboard!","Error",JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private class PicPanel extends JPanel implements ActionListener{
        ...
        private void initPanel(){
            ...
            copy=new JButton("COPY TO CLIPBOARD(C)");
    ...
    private class Temp extends JPanel implements MouseListener,MouseMotionListener{
        ...
        public void paintComponent(Graphics g){
            ...
            if(showTip){
                ...
                g.drawString("Please Hold on left mouse button, and select desired area",p.x,p.y+15);
            }
        }
